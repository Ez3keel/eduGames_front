...
export default function CorridaGamePage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-primary/10 dark:from-gray-900 dark:to-secondary/50 transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-primary dark:text-primary-dark">Corrida</h1>
          <p className="text-gray-600 dark:text-gray-300 mt-2">
            Teste seus reflexos e conhecimentos nesta emocionante corrida educativa
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 mb-8 transition-colors duration-300">
            <div className="w-[1024px] h-[768px] overflow-hidden">
              <iframe
                src="https://ez3keel.github.io/Corrida/"
                title="Corrida"
                width="1024"
                height="768"
                className="border-0"
        ...
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors duration-300">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
            <li>Use os controles para guiar seu personagem na pista de corrida</li>
            <li>Responda corretamente às perguntas que aparecem durante a corrida</li>
            <li>Colete itens de bônus para ganhar velocidade ou vantagens</li>
            <li>Evite obstáculos e armadilhas que podem reduzir sua velocidade</li>
            <li>Chegue à linha de chegada no menor tempo possível</li>
          </ul>
          ...
          <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-md">
            ...
            <p className="text-yellow-600 dark:text-yellow-300">
              Equilibre velocidade e precisão! Responder corretamente às perguntas pode dar mais vantagem do que
              simplesmente correr o mais rápido possível.
            </p>
          </div>
        </div>
      </main>
