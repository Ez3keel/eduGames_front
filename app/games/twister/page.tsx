...
export default function TwisterGamePage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-primary/10 dark:from-gray-900 dark:to-secondary/50 transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-primary dark:text-primary-dark">Twister</h1>
          <p className="text-gray-600 dark:text-gray-300 mt-2">
            Teste sua flexibilidade e coordenação nesta versão digital do clássico jogo Twister
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 mb-8 transition-colors duration-300">
            <div className="w-[1024px] h-[768px] overflow-hidden">
              <iframe
                src="https://ez3keel.github.io/twister/"
                title="Twister"
                width="1024"
                height="768"
                className="border-0"
        ...
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors duration-300">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
            <li>Siga as instruções que aparecem na tela para posicionar suas mãos e pés</li>
            <li>Coloque a parte do corpo indicada na cor correspondente do tapete</li>
            <li>Mantenha o equilíbrio enquanto segue as novas instruções</li>
            <li>Tente não cair ou tocar o chão com outras partes do corpo</li>
            <li>O jogo fica mais desafiador conforme você progride</li>
          </ul>
          ...
          <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-md">
            ...
            <p className="text-yellow-600 dark:text-yellow-300">
              Mantenha a calma e respire fundo! O equilíbrio é mais fácil de manter quando você está relaxado. Tente
              distribuir seu peso de forma equilibrada entre os pontos de apoio.
            </p>
          </div>
        </div>
      </main>
