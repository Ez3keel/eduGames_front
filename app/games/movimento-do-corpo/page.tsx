...
export default function MovimentoDoCorpoGamePage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-primary/10 dark:from-gray-900 dark:to-secondary/50 transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-primary dark:text-primary-dark">Movimento do Corpo</h1>
          <p className="text-gray-600 dark:text-gray-300 mt-2">
            Aprenda sobre anatomia e os diferentes movimentos que o corpo humano pode realizar
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 mb-8 transition-colors duration-300">
            <div className="w-[1024px] h-[768px] overflow-hidden">
              <iframe
                src="https://ez3keel.github.io/MovimentoDoCorpo/"
        ...
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors duration-300">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
            <li>Explore as diferentes partes do corpo humano apresentadas no jogo</li>
            <li>Aprenda sobre os sistemas muscular, esquelético e articular</li>
            <li>Identifique os tipos de movimentos que cada articulação pode realizar</li>
            <li>Responda às perguntas sobre anatomia e fisiologia do movimento</li>
            <li>Complete os desafios para testar seu conhecimento sobre o corpo humano</li>
          </ul>
          ...
          <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-md">
            ...
            <p className="text-yellow-600 dark:text-yellow-300">
              Observe como os músculos e ossos trabalham juntos para produzir movimento. Entender essa relação é
              fundamental para compreender como nosso corpo se move!
            </p>
          </div>
        </div>
      </main>
