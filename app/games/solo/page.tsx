    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-primary/10 dark:from-gray-900 dark:to-secondary/50 transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-primary dark:text-primary-dark">Solo</h1>
          <p className="text-gray-600 dark:text-gray-300 mt-2">
            Aprenda sobre os diferentes tipos de solo e suas características
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 mb-8 transition-colors duration-300">
            <div className="w-[1024px] h-[768px] overflow-hidden">
              <iframe
                src="https://ez3keel.github.io/Solos/"
                title="Solo"
                width="1024"
                height="768"
                className="border-0"
        ...
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors duration-300">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
            <li>Observe as imagens e descrições dos diferentes tipos de solo</li>
            <li>Aprenda sobre as características de cada tipo de solo</li>
            <li>Responda às perguntas sobre composição, textura e propriedades dos solos</li>
            <li>Identifique qual tipo de solo é mais adequado para diferentes usos</li>
            <li>Complete os desafios para testar seu conhecimento sobre solos</li>
          </ul>
          ...
          <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-md">
            ...
            <p className="text-yellow-600 dark:text-yellow-300">
              Preste atenção à cor e textura dos solos nas imagens. Estes são indicadores importantes que podem ajudar a
              identificar o tipo de solo e suas propriedades!
            </p>
          </div>
        </div>
      </main>
