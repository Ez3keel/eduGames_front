...
export default function RitmosGamePage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-primary/10 dark:from-gray-900 dark:to-secondary/50 transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-primary dark:text-primary-dark">Ritmos</h1>
          <p className="text-gray-600 dark:text-gray-300 mt-2">
            Desenvolva sua percepção musical e senso rítmico com este jogo divertido
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 mb-8 transition-colors duration-300">
            <div className="w-[1024px] h-[768px] overflow-hidden">
              <iframe
                src="https://ez3keel.github.io/Ritmos/"
                title="Ritmos"
                width="1024"
                height="768"
                className="border-0"
        ...
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors duration-300">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
            <li>Ouça atentamente a sequência rítmica apresentada</li>
            <li>Tente memorizar o padrão de sons e pausas</li>
            <li>Reproduza o ritmo clicando nos botões na ordem correta</li>
            <li>Seja preciso com o tempo entre os cliques para reproduzir o ritmo fielmente</li>
            <li>Avance para padrões mais complexos conforme progride no jogo</li>
          </ul>
          ...
          <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-md">
            ...
            <p className="text-yellow-600 dark:text-yellow-300">
              Tente bater o ritmo com a mão enquanto ouve a sequência. Isso pode ajudar a internalizar o padrão antes de
              tentar reproduzi-lo no jogo!
            </p>
          </div>
        </div>
      </main>
