...
export default function DonoRRRGamePage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-primary/10 dark:from-gray-900 dark:to-secondary/50 transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-primary dark:text-primary-dark">Dono R_RR</h1>
          <p className="text-gray-600 dark:text-gray-300 mt-2">
            Aprenda quando usar R ou RR nas palavras da língua portuguesa
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 mb-8 transition-colors duration-300">
            <div className="w-[1024px] h-[768px] overflow-hidden">
              <iframe
                src="https://ez3keel.github.io/DonoR_RR/"
                title="Dono R_RR"
                width="1024"
                height="768"
                className="border-0"
        ...
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors duration-300">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
            <li>Observe as palavras apresentadas com espaços para completar</li>
            <li>Decida se deve usar R ou RR para completar corretamente a palavra</li>
            <li>Selecione a opção que você acredita ser a correta</li>
            <li>Ganhe pontos por cada resposta correta</li>
            <li>Avance pelos níveis para aprimorar seu conhecimento sobre o uso de R e RR</li>
          </ul>
          ...
          <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-md">
            ...
            <p className="text-yellow-600 dark:text-yellow-300">
              Geralmente, usamos RR entre vogais quando o som é forte (como em "carro"). Usamos R no início das palavras
              (como em "rato") ou após consoantes (como em "honra").
            </p>
          </div>
        </div>
      </main>
