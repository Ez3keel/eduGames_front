...
export default function GuerraDosPolitonosGamePage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-primary/10 dark:from-gray-900 dark:to-secondary/50 transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-primary dark:text-primary-dark">Guerra dos Polígonos</h1>
          <p className="text-gray-600 dark:text-gray-300 mt-2">
            Aprenda geometria de forma divertida nesta batalha épica entre formas geométricas
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 mb-8 transition-colors duration-300">
            <div className="w-[1024px] h-[768px] overflow-hidden">
              <iframe
                src="https://ez3keel.github.io/Guerradospol-gonos/"
                title="Guerra dos Polígonos"
                width="1024"
                height="768"
                className="border-0"
        ...
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors duration-300">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
            <li>Escolha seu polígono favorito para entrar na batalha</li>
            <li>Aprenda sobre as propriedades de cada forma geométrica</li>
            <li>Use as características especiais de cada polígono para vencer os desafios</li>
            <li>Responda corretamente às perguntas sobre geometria para ganhar poder</li>
            <li>Derrote todos os oponentes para se tornar o campeão dos polígonos</li>
          </ul>
          ...
          <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-md">
            ...
            <p className="text-yellow-600 dark:text-yellow-300">
              Cada polígono tem suas próprias características únicas! Triângulos são estáveis, quadrados são
              equilibrados, e círculos são versáteis. Escolha sabiamente!
            </p>
          </div>
        </div>
      </main>
