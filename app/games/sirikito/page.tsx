...
export default function SirikitoGamePage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-primary/10 dark:from-gray-900 dark:to-secondary/50 transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-primary dark:text-primary-dark">Sirikito</h1>
          <p className="text-gray-600 dark:text-gray-300 mt-2">
            Teste seus reflexos e coordenação neste divertido jogo de habilidade
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 mb-8 transition-colors duration-300">
            <div className="w-[1024px] h-[768px] overflow-hidden">
              <iframe
                src="https://ez3keel.github.io/SirikitoGame/"
                title="Sirikito"
                width="1024"
                height="768"
                className="border-0"
        ...
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors duration-300">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
            <li>Use os controles para mover o personagem na tela</li>
            <li>Reaja rapidamente aos obstáculos e desafios que aparecem</li>
            <li>Colete itens para ganhar pontos e habilidades especiais</li>
            <li>Evite armadilhas e inimigos que podem reduzir sua pontuação</li>
            <li>Tente chegar o mais longe possível para obter a maior pontuação</li>
          </ul>
          ...
          <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-md">
            ...
            <p className="text-yellow-600 dark:text-yellow-300">
              Mantenha a calma e tente antecipar os obstáculos. Quanto mais você jogar, melhor será seu tempo de reação
              e coordenação!
            </p>
          </div>
        </div>
