...
export default function SuspeitoGamePage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-primary/10 dark:from-gray-900 dark:to-secondary/50 transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-6">
          <h1 className="text-2xl md:text-3xl font-bold text-primary dark:text-primary-dark">O Suspeito</h1>
          <p className="text-gray-600 dark:text-gray-300 mt-2">
            Use suas habilidades de dedução para encontrar o suspeito correto
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 mb-8 transition-colors duration-300">
            <div className="w-[1024px] h-[768px] overflow-hidden">
              <iframe
                src="https://ez3keel.github.io/game_suspeito/"
                title="O Suspeito"
                width="1024"
                height="768"
                className="border-0"
        ...
        <div className="max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-colors duration-300">
          ...
          <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
            <li>Leia atentamente as pistas fornecidas sobre o suspeito</li>
            <li>Analise as características de cada personagem apresentado</li>
            <li>Elimine os personagens que não correspondem às pistas</li>
            <li>Selecione o personagem que você acredita ser o suspeito correto</li>
            <li>Quanto mais rápido você identificar o suspeito, mais pontos ganhará</li>
          </ul>
          ...
          <div className="mt-6 p-4 bg-yellow-50 dark:bg-yellow-900/30 rounded-md">
            ...
            <p className="text-yellow-600 dark:text-yellow-300">
              Preste atenção a todos os detalhes nas pistas. Às vezes, a informação mais importante pode estar em um
              pequeno detalhe que parece insignificante!
            </p>
          </div>
        </div>
      </main>
